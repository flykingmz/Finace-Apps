<template>
  <div class="other-calculators-page">
    <!-- Header -->
    <h1>📊 Other Calculators</h1>
    <p class="category-description">
      Explore our comprehensive collection of financial calculators to estimate loans, payments, taxes, debt, business costs, and budgeting, helping you make smarter financial decisions and plan your money with confidence.
    </p>
    ...
    <div class="calculators-grid">
      ...
      <div class="calculator-card">
        <div class="card-icon"><span class="icon">💰</span></div>
      ...
      <div class="calculator-card">
        <div class="card-icon"><span class="icon">⏱️</span></div>
        <div class="card-content">
...
export default {
  ...
  mounted() {
    // 设置页面标题
    document.title = 'Other Calculators - Financial Tools';
  }
}
</script>
...
.calculator-card:hover {
  ...
  box-shadow: 0 24px 40px -12px rgba(37, 99, 235, 0.15);
  border-color: #b9d1f0;
}
