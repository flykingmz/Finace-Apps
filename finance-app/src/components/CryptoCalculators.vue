...
export default {
  ...
  methods: {
    setGoogleMetaTags() {
      ...
      desc.content = 'Explore free crypto calculators to estimate crypto tax, capital gains, staking rewards, mining income, and DeFi earnings. Use our crypto tax calculator, capital gains calculator, and portfolio tools to manage your cryptocurrency investments accurately.'
  ...
  mounted() {
    document.title = 'Crypto Calculators – Crypto Tax, Capital Gains, Staking, Mining & DeFi Tools'
